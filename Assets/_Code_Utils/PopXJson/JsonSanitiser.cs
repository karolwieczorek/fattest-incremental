...
*/
		...
		public static string DoubleArrayToMemberSimple(string Json, string parent, string member)
		{
			return DoubleArrayToMember( Json, (ParentName) => {	return ParentName == parent ? member : null;	} );
		}
